...
class HomeViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        configureNavigationBar(titleText: "ACTS")
    ...
    private func configureUI() {
        ...
        guard statusBarBehaviors.firstIndex(of: preferences.statusBarBehavior) != nil else {
            fatalError("Configuration is messed up")
        }
        //        statusBarBehaviorSegment.selectedSegmentIndex = behaviorIndex
        
        guard menuPosition.firstIndex(of: preferences.position) != nil else {
            fatalError("Configuration is messed up")
        }
        //        menuPositionSegment.selectedSegmentIndex = menuPositionIndex
        
        guard menuDirections.firstIndex(of: preferences.direction) != nil else {
            fatalError("Configuration is messed up")
        }
        //        menuDirectionSegment.selectedSegmentIndex = menuDirectionIndex
        
        guard menuOrientation.firstIndex(of: preferences.supportedOrientations) != nil else {
            fatalError("Configuration is messed up")
        }
